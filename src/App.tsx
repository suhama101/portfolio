          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 relative z-10">
            <div>
              ...
              <p className="text-slate-400 text-sm max-w-3xl mt-4 leading-relaxed">
                Production experience building AI-powered web environments for live government structures like the <strong className="text-slate-200 font-semibold">Inter Services Selection Board (ISSB)</strong> and the <strong className="text-slate-200 font-semibold">Pakistan Army (PAGB)</strong>. Armed with precise REST architectures, modern Next.js/React, and LLM automation.
              </p>
            </div>
